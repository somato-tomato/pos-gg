...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  watch: {
    'cart.barang_id': function cartBarang_id() {
  ...
  methods: {
    getBarang: function getBarang() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/api/barang/".concat(this.cart.barang_id)).then(function (response) {
        _this2.barang = response.data;
      });
    },
...
module.exports = __webpack_require__(/*! D:\PROJECT\pos-gg\resources\js\transaksi.js */"./resources/js/transaksi.js");
