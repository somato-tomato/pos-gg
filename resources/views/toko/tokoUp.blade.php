    ...
    <div class="content" id="dw">
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="{{ route('toko.update', $toko->id) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namaToko" name="namaToko" value="{{ $toko->namaToko }}">
                                </div>

                                <div class="form-group">
                                    <label for="alamatToko" class="bmd-label-static">Alamat Supplier</label>
                                    <input type="text" class="form-control" id="alamatToko" name="alamatToko" value="{{ $toko->alamatToko }}">
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="nomorToko" name="nomorToko" value="{{ $toko->nomorToko }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="emailToko" class="bmd-label-static">Email Toko</label>
                                            <input type="email" class="form-control" id="emailToko" name="emailToko" value="{{ $toko->emailToko }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="websiteToko" class="bmd-label-static">Website</label>
                                            <input type="text" class="form-control" id="websiteToko" name="websiteToko" value="{{ $toko->websiteToko }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
