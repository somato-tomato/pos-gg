            ...
            <div class="card-body">
              ...
              <div class="row">
                   ...
                   @endforeach
                    ...
                    <div class="col">
                      <input type="text" name="search"class="form-control" placeholder="Name Product" onblur="this.form.submit()">
                    </div>
                      <div class="col">
              ...
              <p class="card-category"></p>
                    ...
                    <div style="overflow-y:auto;min-height:53vh;max-height:53vh" class="mb-3">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <form action="{{url('/transaksii/removeproduct',$item['rowId'])}}"
                                            method="POST">
                                            @csrf
                                    ...
                                    <td class="text-right">
                                        <form action="{{url('/transaksii/increasecart1', $item['rowId'])}}"
                                            method="POST" style='display:inline;'>
                    ...
                    <table class="table table-sm table-borderless">
                        <tr>
                            ...
                            <input type="text" id="sub"></input>Rp.
                    ...
                    <!--     <div class="col-sm-4">
                            <a class="btn btn-primary btn-lg btn-block"
                                style="padding:1rem!important" href="{{url('/transaksii/history')}}" target="_blank">History</a>
